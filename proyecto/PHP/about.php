      ...
      <div class="container">
        ...
        <a class="nav-link dropdown-toggle one" href="#" id="navbarDropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
          ...
          if (isset($_SESSION['user'])){ 
            echo '<a class="dropdown-item" href="/PHP/editaccount.php">Configuracion</a>
                    <a class="dropdown-item" href="/PHP/destroysession.php">Cerrar sesion</a>  ';
          }else{
            
            echo '<a class="dropdown-item" href="/HTML/login.html">Iniciar sesion</a>';
          }
          ?>
        ...
        <li class="nav-item">
          <?php
          if (isset($_SESSION['user'])){ 
            echo '<a class="nav-link" href="/PHP/destroysession.php">Cerrar sesión</a>';
          }else{
            
            echo '<a class="nav-link" href="/HTML/login.html">Iniciar sesión</a>';
          }
          ?>
        </li>
          </ul>
